...
(1, 'Federeso', 'Jomel', 'Concepcion', 'Male', 'Computer Science'),
(2, 'Gallardo ', 'Robert', 'Ofamin', 'Male', 'Computer Science'),
(3, 'Castillo', 'Jeric', 'Avenido', 'Male', 'Computer Science'),
(5, 'Reyes', 'Jobers', 'Bernales', 'Male', 'Computer Science');
...
('BSCS', 1, 'IT REVIEW', 'Information Technology Review', '3', '2023-2024', '1', '1st Semester', 'B', 'Monday', '8:00 - 9:00', 'CB 205'),
('BSHM', 2, 'EM', 'Event Management', '3', '2023-2024', '1', '1st Semester', 'A', 'Tuesday', '8:00 - 10:00', 'CB 205'),
('BEED', 3, 'Math', 'Mathematics', '3', '2023-2024', '1', '1st Semester', 'A', 'Friday', '11:00 - 12:00', 'CB 207'),
...
--
ALTER TABLE `instructor`
  MODIFY `instructor_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `room`
--
ALTER TABLE `room`
  MODIFY `room_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `subject`
  MODIFY `subject_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
COMMIT;
